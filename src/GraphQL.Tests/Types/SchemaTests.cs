...
namespace GraphQL.Tests.Types
{
    public class SchemaTests
    {
        ...
        [Test]
        public void throw_error_on_non_graphtype_with_register_type()
        {
            var schema = new Schema();
            Expect.Throws<ArgumentOutOfRangeException>(() => schema.RegisterType(typeof(MyDto)));
        }
        
        [Test]
        public void throw_error_on_null_with_register_type()
        {
            var schema = new Schema();
            Expect.Throws<ArgumentOutOfRangeException>(() => schema.RegisterType(null));
        }
